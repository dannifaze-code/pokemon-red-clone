// ============================================
// ORIGINAL POKEMON SPECIES - Avoid copyright with unique designs
// ============================================
...
const ORIGINAL_SPECIES = {
    ...
    LEAFLING: {
        ...
        evolution: { level: 16, into: 'GROVEGUARDIAN' },
        catchRate: 45,
        expYield: 64,
        growthRate: 'medium_slow',
        description: 'A small plant creature with leafy wings.'
    },
    GROVEGUARDIAN: {
        id: 2,
        name: 'GROVEGUARDIAN',
        ...
        evolution: { level: 32, into: 'FORESTTITAN' },
        catchRate: 45,
        expYield: 142,
        growthRate: 'medium_slow',
        description: 'A guardian of the forest with hardened bark armor.'
    },
    FORESTTITAN: {
        id: 3,
        name: 'FORESTTITAN',
        ...
        expYield: 236,
        growthRate: 'medium_slow',
        description: 'A massive titan that protects ancient forests.'
    },
    ...
    EMBERL: {
        ...
        evolution: { level: 16, into: 'BLAZECLAW' },
        catchRate: 45,
        expYield: 62,
        growthRate: 'medium_slow',
        description: 'A fiery creature with ember-like markings.'
    },
    BLAZECLAW: {
        id: 5,
        name: 'BLAZECLAW',
        ...
        evolution: { level: 36, into: 'INFERNOBEAST' },
        catchRate: 45,
        expYield: 142,
        growthRate: 'medium_slow',
        description: 'A fierce predator with burning claws.'
    },
    INFERNOBEAST: {
        id: 6,
        name: 'INFERNOBEAST',
        ...
        expYield: 240,
        growthRate: 'medium_slow',
        description: 'A legendary beast that commands eternal flames.'
    },
    ...
    AQUAFIN: {
        ...
        evolution: { level: 16, into: 'TIDEGUARDIAN' },
        catchRate: 45,
        expYield: 63,
        growthRate: 'medium_slow',
        description: 'A small water creature with fin-like wings.'
    },
    TIDEGUARDIAN: {
        id: 8,
        name: 'TIDEGUARDIAN',
        ...
        evolution: { level: 36, into: 'OCEANTITAN' },
        catchRate: 45,
        expYield: 142,
        growthRate: 'medium_slow',
        description: 'A guardian of coastal waters with hardened scales.'
    },
    OCEANTITAN: {
        id: 9,
        name: 'OCEANTITAN',
        ...
        expYield: 239,
        growthRate: 'medium_slow',
        description: 'A massive titan that rules the ocean depths.'
    },
    ...
    SKYWING: {
        ...
        evolution: { level: 18, into: 'AERIALACE' },
        catchRate: 255,
        expYield: 50,
        growthRate: 'medium_slow',
        description: 'A common bird found in grassy areas.'
    },
    AERIALACE: {
        id: 17,
        name: 'AERIALACE',
        ...
        evolution: { level: 36, into: 'SKYLORD' },
        catchRate: 120,
        expYield: 122,
        growthRate: 'medium_slow',
        description: 'A swift flyer with aerial acrobatic skills.'
    },
    SKYLORD: {
        id: 18,
        name: 'SKYLORD',
        ...
        expYield: 216,
        growthRate: 'medium_slow',
        description: 'The ruler of the skies with unmatched speed.'
    },
    ...
    SCRATCHCLAW: {
        ...
        evolution: { level: 20, into: 'FANGSTRIKER' },
        catchRate: 255,
        expYield: 51,
        growthRate: 'medium_fast',
        description: 'A quick creature with sharp claws.'
    },
    FANGSTRIKER: {
        id: 20,
        name: 'FANGSTRIKER',
        ...
        expYield: 145,
        growthRate: 'medium_fast',
        description: 'A fierce predator with deadly fangs.'
    },
    ...
    SILKWORM: {
        ...
        evolution: { level: 7, into: 'COONCOON' },
        catchRate: 255,
        expYield: 39,
        growthRate: 'medium_fast',
        description: 'A small worm that produces silk threads.'
    },
    COONCOON: {
        id: 11,
        name: 'COONCOON',
        ...
        learnset: { 1: ['TACKLE', 'STRING_SHOT'] },
        evolution: { level: 10, into: 'BUTTERFLIGHT' },
        catchRate: 120,
        expYield: 72,
        growthRate: 'medium_fast',
        description: 'A cocoon stage preparing for transformation.'
    },
    BUTTERFLIGHT: {
        id: 12,
        name: 'BUTTERFLIGHT',
        ...
        expYield: 178,
        growthRate: 'medium_fast',
        description: 'A beautiful butterfly with psychic powers.'
    },
    ...
    SPARKLE: {
        ...
        evolution: { item: 'THUNDER_STONE', into: 'VOLTAJOLT' },
        catchRate: 190,
        expYield: 112,
        growthRate: 'medium_fast',
        description: 'A small electric creature that crackles with energy.'
    },
    VOLTAJOLT: {
        id: 26,
        name: 'VOLTAJOLT',
    ...
    MYSTICORE: {
        ...
        growthRate: 'slow',
        isLegendary: true,
        description: 'A legendary psychic being with immense power.'
    }
};

// Use the same growth rate formulas
const GROWTH_RATES = {
...
function getSpecies(speciesId) {
    return ORIGINAL_SPECIES[speciesId] || null;
}
...
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { ORIGINAL_SPECIES, GROWTH_RATES, getSpecies, getLearnableMoves, getExpForLevel };
}
